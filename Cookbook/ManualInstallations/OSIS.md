...
class MockOSIS():
    def mock():
        ...
        j.core.osis.startDaemon(path="", overwriteHRD=False, overwriteImplementation=False, key="", port=5544, superadminpasswd='rooter', dbconnections={'mongodb':'main', 'influxdb':'main'}, hrd='')
